...
const CarDetail = ({ car }: Props) => {
  return (
    <div className="max-w-6xl mx-auto h-full w-full flex flex-col rounded-2xl relative">
      <div className="rounded-2xl border border-[#323436] relative overflow-hidden pt-80 rounded-b-none">
        ...
        />
        <div className="absolute inset-0 bg-black/80 rounded-xl rounded-b-none " />
        ...
        <div className="flex justify-between w-full relative z-10 p-5">
          ...
          <div className="flex flex-col gap-3 ">
            ...
            <div className="text-xs text-[#b9b5ac]">
